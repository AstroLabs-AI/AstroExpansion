...
public class ElectricFurnaceMenu extends BaseContainerMenu {
    ...
    public ElectricFurnaceMenu(int containerId, Inventory playerInventory, BlockEntity blockEntity, ContainerData data) {
        super(AEMenuTypes.ELECTRIC_FURNACE.get(), containerId, playerInventory, (ElectricFurnaceBlockEntity) blockEntity, 2);
